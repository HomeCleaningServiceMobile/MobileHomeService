package com.example.prm_project.utils;
    ...
    public class Constants {
        ...
        public static final String ENDPOINT_MONTHLY_REVENUE = "AdminDashboard/monthly-revenue";
        public static final String ENDPOINT_TOP_SERVICES = "AdminDashboard/top-services";
        public static final String ENDPOINT_USER_SUMMARY = "AdminDashboard/user-summary";
